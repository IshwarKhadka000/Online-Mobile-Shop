...
<section id="product" class="py-3">
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                <img src="<?php echo $item['image'] ??"./assets/products/default.png";?>" alt="product" class="img-fluid">
                <div class="row pt-4 font-size-16 font-baloo">
                    <div class="col">
                        <button type="submit" class="btn btn-danger form-control">Proceed to Buy</button>
                    </div>
                    <div class="col">
                        <a href="cart.php"><button type="submit" class="btn btn-warning form-control">Add to Cart</button></a>
                    </div>
                </div>
            </div>
            <div class="col-sm-6">
                ...
                <div class="policy">
                    <div class="d-flex">
                        ...
                        <div class="return text-center mr-5 px-4">
                            ...
                            <a href="#" class="font-rale font-size-12">Free<br />Deliveryt</a>
                        </div>
                        <div class="return text-center mr-5">
                            <div class="font-size-20 my-2 color-second">
                    ...
                    <div class="col-6">
                        ...
                        <div class="color my-3">
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="p-2 color-yellow-bg rounded-circle"><button class="btn font-size-14"></div>
                                <div class="p-2 color-blue-bg rounded-circle"><button class="btn font-size-14"></div>
                                <div class="p-2 color-secondary-bg rounded-circle"><button class="btn font-size-14"></div>
                            </div>
                        </div>
                        <!-- End Color  -->
                    </div>
